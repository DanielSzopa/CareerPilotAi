...
1. Zidentyfikuj kluczowe widoki i ekrany na podstawie wymagań produktu, dostępnych endpointów oraz ViewModels.
...
8. Zignoruj widoki dla auth e.g. auth, register, forgot password, reset password, etc.
